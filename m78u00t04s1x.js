...
function showRedirectModal(data) {
    ...
    let title = '¡Bienvenido a nuestro nuevo casino!';
    let description = 'Nos hemos trasladado a una nueva plataforma para ofrecerte mejores servicios y oportunidades aún más emocionantes. Regístrate de nuevo con nosotros y recibe un bono especial.';
    let bonus = 'Bono Especial de Bienvenida';
    let button_text = '¡Reclamar bono! 🎁';
